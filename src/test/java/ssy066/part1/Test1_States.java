 ...
 *
 * When you implement your best help is http://docs.oracle.com/javase/8/docs/api/
 *
...
public class Test1_States extends TestCase {
	 ...
	 *
	 */
	public void test1_createAState() {
     ...
     *
     */
    public void test2_getFromState() {
        Map<String, Object> stateMap = new HashMap<String, Object>();
        stateMap.put("v1", 0); stateMap.put("v2", "atHome");
        State state = new State(stateMap);
     ...
     *
     */
    public void test3_ImmutableState() {
	 ...
	 */
	public void test5_updateState2() {
        Map<String, Object> stateMap = new HashMap<String, Object>();
